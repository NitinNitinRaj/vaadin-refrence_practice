package com.nr.vaadinpractice.practicalVaadin.grid.service;

import com.nr.vaadinpractice.practicalVaadin.grid.entity.Book;
import com.nr.vaadinpractice.practicalVaadin.grid.entity.Publisher;
...
public class BookService {
  ...
  public static void decreaseQuantity(Book book) {
    int newQuantity = book.getQuantity() - 1;
    if (newQuantity > 0) {
      book.setQuantity(newQuantity);
    }
