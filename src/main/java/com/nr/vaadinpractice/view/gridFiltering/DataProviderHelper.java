...
public class DataProviderHelper {
  ...
  private static final int numItems = 1000;
  ...
  private static class ProductBeanCreator extends BeanCreator<Product> {
    ...
    private static final String NAMES =
      "Knife Scythe Sickle Hammer Maul Screwdriver Saw Pliers Wrench";
    ...
    public Product createItem() {
      ...
      final LocalDate date = LocalDate
        .now()
        .plusMonths(rand.nextInt(2) + 1)
        .withDayOfMonth(rand.nextInt(25) + 1);
